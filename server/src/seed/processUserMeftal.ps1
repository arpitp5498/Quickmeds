...
$src = "C:\Users\arpit\.gemini\antigravity\brain\8cabef4e-9ef7-43ec-96b1-f84cdf89d73f\.user_uploaded\media_1788022724936.png"
$dest = "c:\Users\arpit\OneDrive\Documents\medirush\client\public\medicines\meftal-spas-tablet.png"
...
$outBmp.Dispose()
Write-Host "Meftal Spas photo successfully processed and saved to $dest (${destW}x${destH} centered on 600x600)"
