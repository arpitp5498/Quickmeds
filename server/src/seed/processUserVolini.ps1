...
$src = "C:\Users\arpit\.gemini\antigravity\brain\8cabef4e-9ef7-43ec-96b1-f84cdf89d73f\.user_uploaded\media_1788022483019.png"
$dest = "c:\Users\arpit\OneDrive\Documents\medirush\client\public\medicines\volini-pain-relief-gel.png"
...
$outBmp.Dispose()
Write-Host "Volini photo successfully processed and saved to $dest (${destW}x${destH} centered on 600x600)"
